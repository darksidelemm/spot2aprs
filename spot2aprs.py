...
parser.add_argument("--symbolcode",default='C',help="APRS Symbol Code")
...
frame = aprs.util.create_location_frame(
	source=args.mycall,
	destination='APRS',
	latitude = aprs.util.dec2dm_lat(latitude),
	longitude = aprs.util.dec2dm_lng(longitude),
	course=0,
...
#
ais = aprs.APRS(args.mycall,str(args.passcode))
ais.connect()
ais.send(frame)
